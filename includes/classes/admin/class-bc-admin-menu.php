...
class BC_Admin_Menu {
	...
	public function register_admin_menu() {
		...
		add_menu_page( __( 'Brightcove', 'brightcove' ), __( 'Brightcove', 'brightcove' ), 'edit_posts', 'brightcove', array( $this, 'render_settings_page' ) , plugins_url( 'images/admin/menu-icon.svg', dirname( dirname( __DIR__ ) ) ), 50 );
		add_submenu_page( 'brightcove', __( 'Brightcove Videos', 'brightcove' ), __( 'Videos', 'brightcove' ), 'edit_posts', BC_Admin_Menu::get_videos_page_uri_component(), array( $this, 'render_videos_page' ) );
		add_submenu_page( 'brightcove', __( 'Brightcove Playlists', 'brightcove' ), __( 'Playlists', 'brightcove' ), 'edit_posts', BC_Admin_Menu::get_playlists_page_uri_component(), array( $this, 'render_playlists_page' ) );
		add_submenu_page( 'brightcove', __( 'Brightcove Settings', 'brightcove' ), __( 'Settings', 'brightcove' ), 'manage_options', 'brightcove-sources', array( $this, 'render_settings_page' ) );

		// These have no parent menu slug so they don't appear in the menu
		add_submenu_page( null, __( 'Add Source', 'brightcove' ), __( 'Add Source', 'brightcove' ), 'manage_options', 'page-brightcove-edit-source', array( $this, 'render_edit_source_page' ) );
