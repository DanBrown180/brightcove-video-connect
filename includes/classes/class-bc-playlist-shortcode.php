...
class BC_Playlist_Shortcode {
	...
	public static function bc_playlist( $atts ) {
		...
		$defaults = array(
			...
			'account_id'    => '',
			'height'        => 352,
			'width'         => 645, // Nothing shows up playlist-wise when width is under 640px
		);
